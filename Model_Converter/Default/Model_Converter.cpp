// Model_Converter.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
    ...
    // TODO: 여기에 코드를 입력합니다.
    CConverterApp* ConverterApp{ nullptr };

    // 전역 문자열을 초기화합니다.
    LoadStringW(hInstance, IDS_APP_TITLE, szTitle, MAX_LOADSTRING);
    LoadStringW(hInstance, IDC_MODELCONVERTER, szWindowClass, MAX_LOADSTRING);
    ...
    ConverterApp = CConverterApp::Create();
    if (!ConverterApp)
    {
        return FALSE;
    }

    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MODELCONVERTER));
    ...
    while (true)
    {
        ...
        {
            ConverterApp->Tick(pGameInstance->Compute_TimeDelta(L"Timer_60"));
            ConverterApp->Render();
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MODELCONVERTER));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MODELCONVERTER);
