...
HRESULT CHpBar_Player::Init(void* pArg)
{
	...
	__super::Apply_Orthographic(g_iWinSizeX, g_iWinSizeY, 0.8f);
...
HRESULT CHpBar_Player::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(ToIndex(Level_ID::Static), TEXT("Prototype_Component_Texture_HpBar"), TEXT("Com_Texture"), reinterpret_cast<CComponent**>(&m_pTextureCom))))
	{
		return E_FAIL;
	}
