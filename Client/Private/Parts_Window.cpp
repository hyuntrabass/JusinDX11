...
HRESULT CParts_Window::Add_Components()
{
	...
	if (FAILED(__super::Add_Component(ToIndex(Level_ID::CreateCharacter), TEXT("Prototype_Component_Texture_PartsWindow"), TEXT("Com_Texture"), reinterpret_cast<CComponent**>(&m_pTextureCom))))
	{
		return E_FAIL;
	}
